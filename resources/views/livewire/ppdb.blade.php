<div class="container p-5">
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body p-4">
            ...
            <div class="mb-5">
                <div class="alert alert-info">Pastikan data yang Bapak/ibu masukkan sudah benar. Jika sudah mengirim Formulir, informasi selanjutnya akan dikirim melalui WhatsApp.</d>
            </div>
            ...
            <form wire:submit.prevent="kirimPendaftaran">
                ...
                <div class="">
                    <button type="submit" class="btn btn-success fw-bold w-100">Kirim Formulir Pendaftaran</button>
                </div>
            </form>
        </div>
    </div>
